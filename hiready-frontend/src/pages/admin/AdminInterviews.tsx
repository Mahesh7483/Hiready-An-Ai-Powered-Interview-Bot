        ...
        <CardContent className="p-0 overflow-x-auto">
          <Table>
            ...
            <TableBody>
              ...
              {!sessionsQuery.isLoading && (sessionsQuery.isError || sessionsQuery.data === undefined) && (
                <TableRow>
                  <TableCell colSpan={6} className="py-8">
                    <QueryError compact what="interview sessions" error={sessionsQuery.error} onRetry={() => sessionsQuery.refetch()} />
                  </TableCell>
                </TableRow>
              )}
              {!sessionsQuery.isLoading && !sessionsQuery.isError && data?.sessions.length === 0 && (
                <TableRow>
